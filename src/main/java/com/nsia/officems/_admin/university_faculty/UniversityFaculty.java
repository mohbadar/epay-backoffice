...
@Setter
@Getter
@Entity(name = "UniversityFaculty")
@Table(name = "edu_university_faculty")
public class UniversityFaculty extends BaseEntity{
    @Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "edu_university_faculty_tbl_generator")
	@SequenceGenerator(name="edu_university_faculty_tbl_generator", sequenceName = "edu_university_faculty_tbl_seq", allocationSize = 1)
