...
public class AuthController {
    ...
    public ObjectNode updateConfig(Authentication authentication, @RequestParam("lang") String lang,
        ...
        System.out.println("inside user details " + "--" + userDetails.getCurrentLang()+ " -- " + userDetails.getCurrentEnv());
    ...
    private ObjectNode getConfiguration(User user, CustomUser userDetails) throws JsonParseException, IOException {
        ...
        config.put("entity", userDetails.getEntity());
        config.put("entityId", userDetails.getEntityId());
        config.put("department", userDetails.getDepartment());
        config.put("departmentId", userDetails.getDepartmentId());
        config.put("reviewerRequired",user.getReviewerRequired());
        
        ArrayNode accessableDepartments = mapper.createArrayNode();
        for (Department dep : user.getAccessibleDepartments()) {
            accessableDepartments.add(dep.getId());
        }
        config.set("accessableDepartments", accessableDepartments);

        // config.put("entity", "");
        // Department entity = user.getEntity();
        // if(entity != null) {
        //     config.put("entity", entity.getId());
        // }
