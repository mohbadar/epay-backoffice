...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static class JwtAuthSecurityConfiguration extends WebSecurityConfigurerAdapter {
        ...
        private static final String[] AUTH_WHITE_LIST = {
                ...
                // "/**/*.js"
                "/api/public/*",
                "/api/public/documents/{docId}/genQRCode/{width}/{height}",
                "/api/public/executions/{execId}/genQRCode/{width}/{height}",
                "/api/public/user/{Id}/photo",
                "/api/public/download-image/{imageId}",
                "/api/public/download-thumbnail/{imageId}",
