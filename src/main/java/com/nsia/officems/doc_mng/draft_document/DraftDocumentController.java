...
@RestController
@RequestMapping("/api/doc_mng/draft")
public class DraftDocumentController {
    ...
    public Object getDocumentsList(@RequestBody String requestBody) throws Exception {
        ...
        try {
            return draftDocumentService.getMyDocumentsList(input, filters);
        } catch (Exception e) {
    ...
    public Object getExecutionsList(@RequestBody String requestBody) throws Exception {
        ...
        try {
            return draftDocumentService.getMyExecutionsList(input, filters);
        } catch (Exception e) {
            System.out.println("Exception occured" + e.getLocalizedMessage());
        }
        return null;
