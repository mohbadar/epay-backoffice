package com.nsia.officems.hr.employee.dto;
...
//     public static Employee MapProfileDto(Profile profile, EmployeeDto dto, CountryService countryService, ProvinceService provinceService,
...
//     public static EmployeeViewDto EmployeeMapViewDto(Profile profile, LanguageService languageService) {
//         EmployeeViewDto p = new EmployeeViewDto();
//         try {
...
//     public static EmployeeDto EmployeeMapEditDto(Profile profile, LanguageService languageService) {
