package com.nsia.officems.hr.employee.impl;
...
import com.nsia.officems.hr.employee.Employee;
import com.nsia.officems.hr.employee.EmployeeRepository;
import com.nsia.officems.hr.employee.EmployeeService;
import com.nsia.officems.hr.employee.dto.EmployeeDtoMapper;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Object getList(DataTablesInput input, Map<String, String> filters) {
        ...
        return dataTablesUtil.getDataList("public.hr_employee emp", null, joinClause, whereClause, groupByClause, input);
    }

    public Employee findById(Long id) {
        System.out.println("Employee.findById()" + id);
