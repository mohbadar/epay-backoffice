INSERT INTO public.ethnic(
	...
	(3, 't', 'admin', 'f', 'One', ' یکم', 'یکم'),
	(4, 't', 'admin', 'f', 'ُTwo', 'دوم', 'دوم'),
	(5, 't', 'admin', 'f', 'ُThree', ' سوم', 'سوم'),
	(6, 't', 'admin', 'f', 'Fourth', 'چهارم', 'چهارم'),
	(7, 't', 'admin', 'f', 'Fifth', ' پنجم', 'پنجم'),
	(8, 't', 'admin', 'f', 'Sixth', 'ششم', 'ششم'),
	(9, 't', 'admin', 'f', 'Seventh', ' هفتم', 'هفتم'),
	(10,'t', 'admin', 'f', 'Eight', 'هشتم', 'هشتم'),
	(11, 't', 'admin', 'f', 'Ninth', ' نهم', 'نهم'),
	(12,'t', 'admin', 'f', 'Tenth', 'دهم', 'دهم');
	...
	(4, 't', 'admin', 'f', 'One', ' یکم', 'یکم'),
	(5, 't', 'admin', 'f', 'ُTwo', 'دوم', 'دوم'),
	(6, 't', 'admin', 'f', 'ُThree', ' سوم', 'سوم'),
	(7, 't', 'admin', 'f', 'Fourth', 'چهارم', 'چهارم'),
	(8, 't', 'admin', 'f', 'Fifth', ' پنجم', 'پنجم'),
	(9, 't', 'admin', 'f', 'Sixth', 'ششم', 'ششم'),
	(10, 't', 'admin', 'f', 'Seventh', ' هفتم', 'هفتم'),
	(11,'t', 'admin', 'f', 'Eight', 'هشتم', 'هشتم'),
	(12, 't', 'admin', 'f', 'Ninth', ' نهم', 'نهم'),
	(13,'t', 'admin', 'f', 'Tenth', 'دهم', 'دهم');
